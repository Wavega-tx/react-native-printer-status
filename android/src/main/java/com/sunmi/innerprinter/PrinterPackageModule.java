...
public class PrinterPackageModule extends ReactContextBaseJavaModule {
    ...
    public PrinterPackageModule(ReactApplicationContext reactContext) {
       ...
       Intent intent = new Intent();
        intent.setPackage("com.iposprinter");
        intent.setAction("com.iposprinter.iposprinterservice");
        ...
        mFilter.addAction(PAPERLESS_ACTION);
        mFilter.addAction(PAPEREXISTS_ACTION);
        mFilter.addAction(THP_HIGHTEMP_ACTION);
        mFilter.addAction(THP_NORMALTEMP_ACTION);
        mFilter.addAction(MOTOR_HIGHTEMP_ACTION);
        mFilter.addAction(BUSY_ACTION);
        mFilter.addAction(CURRENT_TASK_PRINT_COMPLETE_ACTION);
